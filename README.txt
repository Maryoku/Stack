...
2) Сравнить эффективность двух реализаций. Для этого сгенерировать последовательность операций со стеком из 107 действий (хранить в памяти). Затем проделать указанную последовательность операций с двумя реализациями стека, измеряя при этом продолжительность этой процедуры.
